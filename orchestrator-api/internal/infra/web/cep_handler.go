...
import (
	...
	"github.com/mllcarvalho/go-expert-challenge-otel/orchestrator-api/internal/entity"
	"github.com/mllcarvalho/go-expert-challenge-otel/orchestrator-api/internal/infra/repo"
	"github.com/mllcarvalho/go-expert-challenge-otel/orchestrator-api/internal/usecase"
...
func (h *WebCEPHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	log.Printf("cep_output: %v", cep_output)
	...
	log.Printf("weather_output: %v", weather_output)
